...
### ⬅️ 前提・背景
→ [[JavaScriptバンドラー]], [[ネイティブESModules]], [[JavaScriptビルドツール進化史]]

### ➡️ 発展・結果
→ [[Vite]], [[Viteが開発時esbuild、本番時Rollupを使う理由]], [[Viteの二重構造による最適化戦略]], [[JavaScriptパッケージ公開ツール比較分析]]

### 🔀 別の視点
→ [[esbuild]], [[ビルドツール進化の周期的パターン]]

### 🎯 実践例
→ [[TypeScript二段階ビルドパターン]], [[Typescriptビルドツール比較分析]]
